...
public class AuthorEndpoint {
    ...
    public AddAuthorResponse addAuthor(@RequestPayload AddAuthorRequest request) {
        ...
        Author authorbis = request.getAuthor();
        author.setFirstName(authorbis.getFirstName());
        author.setLastName(authorbis.getLastName());
        author = authorRepository.save(author);

        AddAuthorResponse response = new AddAuthorResponse();
        response.setAuthor(this.toDto(author));
        return response;
    }
